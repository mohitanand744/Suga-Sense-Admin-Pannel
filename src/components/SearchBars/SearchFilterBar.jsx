...
const SearchFilterBar = ({ pathname }) => {
  ...
  return (
    <div
      className={`flex w-full flex-wrap justify-center px-3  ${
    ...
    >
      ...
      {pathname === "dashboardcgmreport" ? (
        ...
        <>
          <div className="flex  items-center px-3 bg-white rounded-md shadow w-full mx-auto md:mx-0 md:w-[15%]">
            <input
              type="text"
          ...
          <div className="flex  items-center px-3 bg-white rounded-md shadow w-full mx-auto md:mx-0 md:w-[20%] xxl:w-[30%]">
            <input
              type="text"
              placeholder="Patientennamen"
              className="w-full p-2 bg-transparent outline-none"
          ...
          {/* Second Input */}
          <div className="flex items-center px-3 bg-white rounded-md shadow w-full sm:w-[25%] mx-auto md:mx-0 md:w-[20%] xxl:w-[30%]">
            <input
              type="text"
          ...
          <label
            ...
            className="flex items-center text-sm md:text-lg  mx-auto hover:scale-105 transition-all duration-200 ease-in md:mx-0 px-2 md:px-4 py-1 md:py-2 font-semibold text-[#0480CA] bg-white rounded-md shadow active:scale-95"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
